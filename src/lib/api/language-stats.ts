...
export const TRACKED_LANGUAGES = [
  ...
  { name: 'Vyper',         soTag: 'vyper',             adzunaQuery: 'vyper ethereum smart contract developer' },
  { name: 'Move',          soTag: 'move-lang',         adzunaQuery: 'move aptos sui blockchain developer' },
  { name: 'Cairo',         soTag: 'cairo-lang',        adzunaQuery: 'cairo starknet blockchain developer' },
  { name: 'Ink!',          soTag: 'ink-lang',          adzunaQuery: 'ink polkadot substrate developer' },
  { name: 'Clarity',       soTag: 'clarity-lang',      adzunaQuery: 'clarity stacks blockchain developer' },
  { name: 'Tact',          soTag: 'tact-lang',         adzunaQuery: 'tact ton blockchain developer' },
