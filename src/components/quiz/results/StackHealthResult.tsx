  ...
  return (
    ...
    >
      ...
      >
          ...
          <Card className="relative overflow-hidden border-2 border-primary/50 bg-primary/5">
            ...
            <div className="relative p-6">
              ...
              <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                ...
                <span>High confidence · Analyzed {stackTechs.length} technologies against live market data</span>
              </div>
            </div>
          </Card>
        </motion.div>
        ...
        <motion.div variants={prefersReducedMotion ? undefined : itemVariants}>
          <NextQuizCTA currentQuiz="stack-health" />
        </motion.div>
        ...
        <motion.div variants={prefersReducedMotion ? undefined : itemVariants}>
          <ResultActions
            onRetake={onRetake}
            retakeLabel="Check Again"
            shareText={`My stack health score on DevTrends: ${recommendation.primary.score}/100 — ${recommendation.primary.action}`}
          />
        </motion.div>
      </motion.div>
    </QuizContainer>
